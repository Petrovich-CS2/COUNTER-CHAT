...
Открой `index.html` в браузере — и всё уже работает.
...
Иконки и дизайн вдохновлены минималистичным стилем CS2. Все фразы собраны на основе реального игрового опыта и сообщества.
